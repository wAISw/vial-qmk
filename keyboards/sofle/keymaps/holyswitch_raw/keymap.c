...
[0] = LAYOUT(
    ...
    KC_TILD,        KC_Q,           KC_W,           KC_E,           KC_R,           KC_T,                                                             KC_Y,           KC_U,           KC_I,           KC_O,           KC_P,           KC_BSLASH,
    KC_TAB,         KC_A,           KC_S,           KC_D,           KC_F,           KC_G,                                                                           KC_H,           KC_J,           KC_K,           KC_L,           KC_SCOLON,      KC_DQUO,
    KC_LSHIFT,      KC_Z,           KC_X,           KC_C,           KC_V,           KC_B,           KC_MEDIA_NEXT_TRACK,                                KC_MEDIA_PLAY_PAUSE,KC_N,           KC_M,           KC_COMMA,       KC_DOT,         KC_SLASH,       KC_ENTER,
    MO(1),          KC_RCTRL,       KC_RALT,        KC_LGUI,        ST_MACRO_0,                                                                                                     KC_SPACE,       KC_LEFT,        KC_RIGHT,       KC_UP,          KC_DOWN
  ),
/*
 * COLEMAK
 * ,-----------------------------------------.                    ,-----------------------------------------.
